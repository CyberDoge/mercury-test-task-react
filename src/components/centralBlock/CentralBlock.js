...
export default class CentralBlock extends React.Component {
  ...
  login(userName, userPhotoSrc){
    this.setState( {isLogin: true, userName: userName, userPhotoSrc: userPhotoSrc})
  }
  ...
  render() {
    return (
      <div className="central-block">
        { this.state.isLogin ?
          < InfoBlock userPhotoSrc={this.state.userPhotoSrc} userName={this.state.userName} logout={this.logout}/>
          :
